...
#change the turtle speed to 1000
turtle.speed(1000)
...
# For red and white stripes, each strip width will be flag_height/13 = 19.2 approx
...
def draw_stripes():
    x = start_x
    y = start_y
    # There are 13 stripes in total, 7 red and 6 white
    # create 6 red and 6 white stripes alternatively
...
draw_square()
# draw long start rows. 30 stars, 6 * 5
draw_six_stars_rows()
# draw short start rows. 20 stars, 5 * 4
